...
export function validateCity(s){
 ...
 return {cityName:cityName.trim(),dayNight:s.dayNight!==false,tutorialDone:s.tutorialDone??buildings.length>0,format:s.format>=3?s.format:2,width,height,gameOver:!!s.gameOver,mapSeed:s.mapSeed,money:s.money,day:s.day,tax:s.tax,cityLevel:s.cityLevel,diseaseDays:s.diseaseDays,crimeDays:s.crimeDays,alerts:s.alerts,debug:false,landUnlocked:s.landUnlocked,river:s.river,buildings,unlockAt,researchPoints,technologies,loan};
}
